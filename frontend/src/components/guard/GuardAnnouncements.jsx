...
const GuardAnnouncements = () => {
  ...
  useEffect(() => {
    ...
    if (user?._id) {
      socketService.joinGuard(user._id);
    }
  }, [user]);
    ...
    <div style={containerStyle}>
      ...
      >
        ...
        <p style={{
          ...
          Send messages to admins or tenants
        </p>
      </motion.div>
          ...
          <div style={{ display: 'flex', gap: '12px', flexWrap: 'wrap' }}>
            ...
            <button
              ...
              style={{
                padding: '12px 24px',
                borderRadius: '12px',
                border: `2px solid ${newAnnouncement.target === 'all' ? '#F59E0B' : '#334155'}`,
                background: newAnnouncement.target === 'all' ? '#F59E0B20' : 'transparent',
                color: '#F1F5F9',
                fontWeight: 600,
                cursor: 'pointer',
                display: 'flex',
                  ...
                  <div style={{ flex: 1 }}>
                    <div style={{ display: 'flex', alignItems: 'center', gap: '8px', marginBottom: '8px' }}>
                      ...
                      <span style={{
                        ...
                        fontSize: '11px',
                        fontWeight: 600,
                        background: announcement.senderRole === 'guard' ? '#F59E0B20' :
                                   announcement.target === 'admins' ? '#3B82F620' : '#22C55E20',
                        color: announcement.senderRole === 'guard' ? '#F59E0B' :
                               announcement.target === 'admins' ? '#3B82F6' : '#22C55E',
                        textTransform: 'capitalize'
                      }}>
                        {announcement.senderRole === 'guard' ? 'You' : announcement.senderRole || 'admin'}
                      </span>
                    </div>
